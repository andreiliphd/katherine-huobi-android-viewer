...
public class PriceSeries extends ArrayList<com.andreiliphd.katherine.scichart.viewer.PriceBar> {
    ...
    public List<Date> getDateData() {
        ...
        for (com.andreiliphd.katherine.scichart.viewer.PriceBar priceBar : this) {

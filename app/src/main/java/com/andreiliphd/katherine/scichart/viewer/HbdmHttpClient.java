...
public class HbdmHttpClient {
	...
	public String callJson(String accessKeyId, String accessKeySecret, String method, String uri, Map<String, String> str,
                           Map<String, String> params) {

		JSONObject jasonObject = JSONObject.parseObject(str.toString());

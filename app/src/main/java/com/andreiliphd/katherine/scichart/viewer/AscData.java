...
public class AscData {
    ...
    public AscData(BufferedReader reader) throws IOException {
        numberColumns = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());
        numberRows = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());
        xllCorner = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());
        yllCorner = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());
        cellSize = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());
        noDataValue = com.andreiliphd.katherine.scichart.viewer.AscData.parseDimension(reader.readLine());

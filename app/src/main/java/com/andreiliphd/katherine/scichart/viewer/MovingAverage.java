...
public class MovingAverage {
    ...
    public com.andreiliphd.katherine.scichart.viewer.MovingAverage update(double value) {
    ...
    public com.andreiliphd.katherine.scichart.viewer.MovingAverage push(double value) {
    ...
    public static List<Double> movingAverage(List<Double> input, int period) {
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage ma = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(period);
    ...
    public static List<Double> rsi(List<com.andreiliphd.katherine.scichart.viewer.PriceBar> input, int period) {
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage averageGain = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(period);
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage averageLoss = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(period);

        final ArrayList<Double> output = new ArrayList<>(input.size());

        // skip first point
        com.andreiliphd.katherine.scichart.viewer.PriceBar previousBar = input.get(0);
        output.add(Double.NaN);

        for (int i = 1, size = input.size(); i < size; i++) {
            final com.andreiliphd.katherine.scichart.viewer.PriceBar priceBar = input.get(i);
    ...
    public static MacdPoints macd(List<Double> input, int slow, int fast, int signal) {
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage maSlow = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(slow);
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage maFast = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(fast);
        final com.andreiliphd.katherine.scichart.viewer.MovingAverage maSignal = new com.andreiliphd.katherine.scichart.viewer.MovingAverage(signal);

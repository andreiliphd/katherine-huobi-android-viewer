...
public class MarketDataService implements IMarketDataService {
    ...
    private final com.andreiliphd.katherine.scichart.viewer.RandomPricesDataSource generator;

    public MarketDataService(Date startDate, int timeFrameMinutes, int tickTimerIntervals) {
        this.generator = new com.andreiliphd.katherine.scichart.viewer.RandomPricesDataSource(timeFrameMinutes, true, tickTimerIntervals, 25, 367367, 30, startDate);
    }
